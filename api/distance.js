...
async function geocode(address) {
  ...
  return { lon: f.geometry.coordinates[0], lat: f.geometry.coordinates[1], label: p.label, confidence: p.confidence, layer: p.layer, accuracy: p.accuracy, hasNumber: !!p.housenumber };
}
